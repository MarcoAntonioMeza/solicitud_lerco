    ...
    switch(parseInt(seccion)){
        case SECCION_GENERAL:
                ...
                if(!$formGenerales.inputSexo.val()){
                    toast("CLIENTE", "El campo  genero es requerido, intenta nuevamente", "warning");
                    is_valid = false;
                }

                if(!$formGenerales.inputApplyBuroCredito.val()){
                    toast("CLIENTE", "Aplica buro de credito es requerido, intenta nuevamente", "warning");
                    is_valid = false;
                }
                ...
                if ($formGenerales.inputApplyBuroCredito.val() == ON) {
                    ...
                    if(!$formGenerales.inputApellidoPaterno.val()){
                        toast("CLIENTE", "El campo  apellido paterno es requerido, intenta nuevamente", "warning");
                        is_valid = false;
                    }
                    if(!$formGenerales.inputApellidoMaterno.val()){
                        toast("CLIENTE", "El campo  apellido materno es requerido, intenta nuevamente", "warning");
                        is_valid = false;
                    }
                }
                ...
                if(!$formGenerales.inputEmail.val()){
                    toast("CLIENTE", "El campo  email es requerido, intenta nuevamente", "warning");
                    is_valid = false;
                }
                ...
                if(!$formGenerales.inputNumSerieFiel.val()){
                    toast("CLIENTE", "El campo  No serie fiel es requerido, intenta nuevamente", "warning");
                    is_valid = false;
                }
                ...
                if($formGenerales.inputPaisNacimiento.val()){
                    if ($('option:selected', $formGenerales.inputPaisNacimiento ).text() === 'MÉXICO') {
                        if(!$formGenerales.inputEntidadNacimiento.val()){
                            toast("CLIENTE", "El campo  entidad de nacimiento es requerido, intenta nuevamente", "warning");
                            is_valid = false;
                        }
                    }
                }
                ...
                if(!$formGenerales.inputEstadoCivil.val()){
                    toast("CLIENTE", "El campo  estado civil es requerido, intenta nuevamente", "warning");
                    is_valid = false;
                }
                ...
                if($formGenerales.inputEstadoCivil.val()){
                    if ($('option:selected', $formGenerales.inputEstadoCivil ).text() === 'CASADO') {
                        if(!$formGenerales.inputRegimenConyugal.val()){
                            toast("CLIENTE", "El campo  regimen conyugal es requerido, intenta nuevamente", "warning");
                            is_valid = false;
                        }
                    }
                }
                ...
                if(!$formGenerales.inputCurp.val()){
                    toast("CLIENTE", "El campo  curp es requerido, intenta nuevamente", "warning");
                    is_valid = false;
                }
                ...
                if(!$formGenerales.inputRegimenFiscal.val()){
                    toast("CLIENTE", "El campo  regimen fiscal es requerido, intenta nuevamente", "warning");
                    is_valid = false;
                }
        ...
        case SECCION_ACTIORIG:
            ...
            is_valid = true;
                ...
                if(!$formActividadOrigen.inputOcupacionProfesional.val()){
                    toast("CLIENTE", "El campo  ocupacion profesional paterno es requerido, intenta nuevamente", "warning");
                    is_valid = false;
                }
...
var valid_add_personas_politicamente_expuesta_otro = function(){
    ...
    if ($formPersonaPoliticamenteExOtro.inputSino.val() == 10) {
        ...
        if ( !$formPersonaPoliticamenteExOtro.inputEjercicioCargo.val() ) {
            toast2("CLIENTE", "El campo ejercicio cargo es requerido, intenta nuevamente", "warning");
            return false;
        }
...
var valid_add_perfil_transaccional_otro = function(){
    ...
    if ( !$formPerfilTransaccionalOtro.inputMontoPago.val() ) {
        toast("CLIENTE", "El campo MONTO es requerido, intenta nuevamente", "warning");
        return false;
    }
...
var valid_add_perfil_transaccional = function(){
    ...
    if ( !$formPerfilTransaccional.inputFrecuencia.val() ) {
        toast("CLIENTE", "El campo Puesto FRECUENCIA es requerido, intenta nuevamente", "warning");
        return false;
    }
